...
**Date:** 2026-08-09 · **Status:** standalone reference; no new measurement was
run for it. Every number below is quoted from a committed document and is
traceable to a named section (the `source` column or the citation on each
table). Where a value is arithmetic over quoted values (a mean of three
published per-seed numbers, a difference of two published seed-means) it is
marked **[derived]** and the inputs are named.
...
test-validated), `PHASE_G.md` (the current model), `FAIR_REMATCH.md` (the
...
| §1 model cards | `RESULTS.md` §Phase G + §Artifacts; `PHASE_F.md` §6, §8, §9; `THREEWAY_AUDIT.md` §3 |
...
| §2.4 | `THREEWAY_AUDIT.md` §2 (quoting `PHASE_E.md` §5, `PHASE_F.md` §8/§14.1); `PHASE_G.md` §4–§5; `FAIR_REMATCH.md` §2–§3 |
...
| §5 | `RESULTS.md` §Phase G + §"Shipping recommendation"; `PHASE_G.md` §6; `FAIR_REMATCH.md` §5 |
